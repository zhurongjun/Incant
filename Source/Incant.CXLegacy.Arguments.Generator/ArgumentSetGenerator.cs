...
namespace Incant.CXLegacy.Arguments.Generator;

/// <summary>Implements the fixed CXLegacy ArgumentSet properties and their typed transformations.</summary>
[Generator(LanguageNames.CSharp)]
public sealed class ArgumentSetGenerator : IIncrementalGenerator
{
    private const string Owner = "Incant.CXLegacy.Arguments.ArgumentSet";
    ...
    private static readonly DiagnosticDescriptor s_invalid = new DiagnosticDescriptor(
        "INCARG001", "Invalid CXLegacy argument property", "{0}", "Arguments", DiagnosticSeverity.Error, true);

    private static readonly DiagnosticDescriptor s_conflict = new DiagnosticDescriptor(
        "INCARG002", "Conflicting CXLegacy argument members", "Generated member '{0}' conflicts with another declaration",
        "Arguments", DiagnosticSeverity.Error, true);

    /// <summary>Discovers optional properties on the CXLegacy configuration type only.</summary>
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        IncrementalValuesProvider<Declaration> fields = context.SyntaxProvider.ForAttributeWithMetadataName(
            "Incant.CXLegacy.Arguments.ArgumentAttribute",
    ...
    private static Declaration Describe(GeneratorAttributeSyntaxContext context)
    {
        ...
        {
            "list" => element is "string" or "global::Incant.CXLegacy.Arguments.RawArgument"
                or "global::Incant.CXLegacy.Arguments.LinkInput" or "global::Incant.CXLegacy.Arguments.Sanitizer",
            ...
            _ => value.SpecialType is SpecialType.System_Boolean or SpecialType.System_Int32
                ...
                || valueType is "global::System.Version" or "global::Incant.CXLegacy.Arguments.Pch"
                    or "global::Incant.CXLegacy.Arguments.Dependencies"
                || value.TypeKind == TypeKind.Enum && value.ContainingNamespace.ToDisplayString()
                    is "Incant.CXLegacy" or "Incant.CXLegacy.Arguments",
        };
        ...
        {
            error = $"'{property.Name}' must be a public, optional, get-only partial property of {Owner} with a supported immutable CXLegacy value type.";
        }
        ...
        INamedTypeSymbol? generationContext = context.SemanticModel.Compilation.GetTypeByMetadataName(
            "Incant.CXLegacy.Arguments.GenerationContext");
    ...
    private static void Emit(SourceProductionContext context, ImmutableArray<Declaration> declarations)
    {
        ...
        source.Line("namespace Incant.CXLegacy.Arguments;");
        source.Line();
