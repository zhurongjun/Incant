...
/// <summary>Source language. When the language key is absent, compilation uses C++.</summary>
...
public sealed record CppRawArgument(
    string Value,
    CppRawPosition Position = CppRawPosition.BeforeInputs,
    CppArgumentRoute Route = CppArgumentRoute.Driver,
    CppOperation? Operation = null,
    CppDialect? Dialect = null,
    CppLanguage? Language = null);
