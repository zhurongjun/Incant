...
public enum CppStandardLibrary
{
    /// <summary>Preserves the tool default.</summary>
    Default,
    /// <summary>LibStdC++ source language.</summary>
    LibStdCpp,
    /// <summary>LibC++ source language.</summary>
    LibCpp,
}

/// <summary>C++ runtime linkage. Explicit static libc++ outside bundles requires runtime archive inputs.</summary>
public enum CppRuntimeLinkage
{
    /// <summary>Preserves the tool default.</summary>
    Default,
...
public enum CppCompilerRuntime
{
...
public sealed record CppPch(CppPchMode Mode, string? Header, string Artifact, string? ObjectOutput = null);

/// <summary>Compiler dependency output format; it does not schedule dependent commands.</summary>
public enum CppDependencyMode
{
...
public sealed record CppDependencies(CppDependencyMode Mode, string? Path = null, string? ObjectName = null);

/// <summary>Emscripten dynamic module mode used consistently during compilation and linking.</summary>
public enum CppWasmModule
{
    /// <summary>Disables this feature explicitly.</summary>
    None,
