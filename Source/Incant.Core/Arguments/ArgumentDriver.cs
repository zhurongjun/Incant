...
/// <summary>Interprets configuration without I/O, mutation, or execution.</summary>
public interface IArgumentDriver
{
    /// <summary>Generates logical arguments; configuration errors are returned as diagnostics.</summary>
    ArgumentGenerationResult Generate(ArgumentSet arguments);
}
...
public sealed class ArgumentDiagnostic
{
    ...
    public ArgumentDiagnostic(ArgumentDiagnosticSeverity severity, string key, string message,
