...
namespace Incant.UnitTest.CXLegacy.FindSdk;
...
public sealed class CompilerResourceTests
{
    ...
    public async Task RealCompilerAliasesMergeAndTheExplicitInvocationIsRetained()
    {
        ...
        var finder = new Incant.CXLegacy.FindTools.Finder([new Incant.CXLegacy.FindTools.CompilerProvider()]);
        Incant.CXLegacy.FindTools.DiscoveryResult result = await finder.FindToolSetsAsync(
