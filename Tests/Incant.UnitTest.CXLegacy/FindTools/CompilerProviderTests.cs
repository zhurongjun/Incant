...
using SdkCompilerProvider = Incant.CXLegacy.FindSdk.CompilerProvider;
...
using ToolCompilerProvider = Incant.CXLegacy.FindTools.CompilerProvider;
using ToolFinder = Incant.CXLegacy.FindTools.Finder;
...
public sealed class CompilerProviderTests
{
    ...
    public async Task HomebrewOptEntryPreservesInvocationAndFindsUnversionedTools()
    {
        ...
        [
            ...
            new Incant.CXLegacy.FindTools.ToolSetQuery
            {
                Kind = ToolKind.Llvm,
        ...
        string compilerName)
    {
        ...
        [
            ...
            TestContext.Current.CancellationToken);
        Incant.CXLegacy.FindSdk.Sdk? discoveredSdk = await new SdkFinder(
        [
    ...
    public async Task WrapperAndSymlinkInvocationPathsArePreserved(string packageManager)
    {
        ...
        Tool? compiler = await toolSet.FindToolAsync(
            ToolNames.Clang, cancellationToken: TestContext.Current.CancellationToken);
        Incant.CXLegacy.FindSdk.Sdk? sdk = await new SdkFinder(
        [
            new SdkCompilerProvider(),
        ]).FindSdkAsync(
            new SdkQuery
    ...
    public async Task RecognizedCompilerWithDifferentFamilyReturnsEmptyResult()
    {
        ...
        Incant.CXLegacy.FindTools.DiscoveryResult toolResult =
            ...
            [
                ...
                TestContext.Current.CancellationToken);
        Incant.CXLegacy.FindSdk.DiscoveryResult sdkResult =
            await new SdkFinder(
            [
                new SdkCompilerProvider(),
            ]).FindSdksAsync(
    ...
    public async Task DirectoryDiscoveryAndCompanionLookupShareVersionedDriverNames(string cName, string cppName)
    {
        ...
        Tool? companion = await toolSet.FindToolAsync(ToolNames.Clangxx,
            cancellationToken: TestContext.Current.CancellationToken);
        Incant.CXLegacy.FindSdk.Sdk? sdk = await new SdkFinder([new SdkCompilerProvider()])
