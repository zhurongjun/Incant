...
using SdkDiscoveryResult = Incant.CXLegacy.FindSdk.DiscoveryResult;
...
using ToolDiscoveryResult = Incant.CXLegacy.FindTools.DiscoveryResult;
...
using ToolSetQuery = Incant.CXLegacy.FindTools.ToolSetQuery;
