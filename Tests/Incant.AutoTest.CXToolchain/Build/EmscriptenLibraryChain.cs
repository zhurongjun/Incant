...
using static Incant.AutoTest.CXToolchain.BuildEnvironment;
        ...
        ResolvedToolchain toolchain)
    {
        ...
        builder.Add(
            ...
            EmscriptenBuildAdapter.CompileArguments(
                ...
                isPic ? WasmModule.Side : WasmModule.None),
        ...
        builder.Add(
            ...
            EmscriptenBuildAdapter.CompileArguments(
                ...
                isPic ? WasmModule.Main : WasmModule.None),
            artifacts: [mainCpp]);
