...
using SdkDiscoveryResult = Incant.CX.FindSdk.DiscoveryResult;
using SdkFinder = Incant.CX.FindSdk.Finder;
using SdkKind = Incant.CX.FindSdk.Kind;
using SdkQuery = Incant.CX.FindSdk.SdkQuery;
using ToolDiscoveryResult = Incant.CX.FindTools.DiscoveryResult;
...
using ToolSetQuery = Incant.CX.FindTools.ToolSetQuery;
