...
internal static class SetupCommandLine
{
    internal static SetupParseResult Parse(IEnumerable<string> arguments)
    {
        ...
        var parser = new CommandParser
        {
            ...
            {
                Name = "Incant.AutoTest.CppToolchain.Setup",
                Help = "Prepares one complete C++ toolchain test environment.",
                Usage = "Incant.AutoTest.CppToolchain.Setup <profile> [options]",
                IsHelpCommand = true,
                SubCommands = profileCommands,
            },
            DefaultBanner = "Incant.AutoTest.CppToolchain.Setup",
        };
        ...
        Action<SetupOptions> selectOptions)
    {
        ...
        return new Command
        {
            ...
            Usage = $"Incant.AutoTest.CppToolchain.Setup {profile.Name} [options]",
