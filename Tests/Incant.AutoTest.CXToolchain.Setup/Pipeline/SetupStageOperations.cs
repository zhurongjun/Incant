        ...
        CancellationToken cancellationToken)
    {
        ...
        _ = SetupPathGuard.RequireFile(
            Path.Combine(
                ...
                "Tests",
                "Incant.AutoTest.CXToolchain",
                "Incant.AutoTest.CXToolchain.csproj"),
            "AutoTest project");
        _ = SetupPathGuard.RequireFile(
            Path.Combine(
                context.Options.Workspace,
                "Tests",
                "Incant.AutoTest.CXToolchain.Setup",
                "Incant.AutoTest.CXToolchain.Setup.csproj"),
            "Setup project");
        ...
        _ = SetupPathGuard.RequireFile(
            Path.Combine(
                ...
                OperatingSystem.IsWindows()
                    ? "Incant.AutoTest.CXToolchain.exe"
                    : "Incant.AutoTest.CXToolchain"),
            "AutoTest apphost");
