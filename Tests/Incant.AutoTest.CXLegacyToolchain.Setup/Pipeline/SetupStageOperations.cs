        ...
        CancellationToken cancellationToken)
    {
        ...
        _ = SetupPathGuard.RequireFile(
            Path.Combine(
                ...
                "Tests",
                "Incant.AutoTest.CXLegacyToolchain",
                "Incant.AutoTest.CXLegacyToolchain.csproj"),
            "AutoTest project");
        _ = SetupPathGuard.RequireFile(
            Path.Combine(
                context.Options.Workspace,
                "Tests",
                "Incant.AutoTest.CXLegacyToolchain.Setup",
                "Incant.AutoTest.CXLegacyToolchain.Setup.csproj"),
            "Setup project");
        ...
        _ = SetupPathGuard.RequireFile(
            Path.Combine(
                ...
                OperatingSystem.IsWindows()
                    ? "Incant.AutoTest.CXLegacyToolchain.exe"
                    : "Incant.AutoTest.CXLegacyToolchain"),
            "AutoTest apphost");
