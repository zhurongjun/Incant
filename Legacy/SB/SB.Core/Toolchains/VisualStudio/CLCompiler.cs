...
namespace SB.Core
{
    ...
    public class CLCompiler : ICompiler
    {
        public CLCompiler(string ExePath, Dictionary<string, string?> Env)
        {
            ...
            BuildInstance.RunProcess(ExePath, "", out var Output, out var Error, Options);
        ...
        public IArgumentDriver CreateArgumentDriver(BuildInstance Instance, CFamily Language, bool isPCH) => new CLArgumentDriver(Instance, Language, isPCH);
