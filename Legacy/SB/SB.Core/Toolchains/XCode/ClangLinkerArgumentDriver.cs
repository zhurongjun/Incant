...
namespace SB.Core
{
    ...
    {
        public ClangLinkerArgumentDriver(BuildInstance Instance, string SDKDirectory)
        {
            RawArguments.Add($"-arch {AppleClangArgumentDriver.GetAppleArchitecture(Instance.TargetArch)}");
